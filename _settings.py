...
#
#
# Какое максимальное количество запросов обрабатывать за один вызов скрипта (общее количество строк)
replication_batch_size = 100000
# Какое максимальное количество файлов binlog-а обрабатывать за один вызов (если поставить слишком много, то может надолго повиснуть)
replication_max_number_files_per_session = 10
#
#
