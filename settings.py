...
key_path_extra = '/home/kalmukds/matomo_click_pass.json.json'
...
MySQL_matomo_dbname = sql['MySQL_matomo_dbname']
MySQL_matomo_user = sql['MySQL_matomo_user']
MySQL_matomo_password = sql['MySQL_matomo_password']
#
CH_matomo_host = click['CH_matomo_host']
CH_matomo_port = click['CH_matomo_port']
CH_matomo_dbname = click['CH_matomo_dbname']
CH_matomo_user = click['CH_matomo_user']
CH_matomo_password = click['CH_matomo_password']
#
#
#
# *** Настройки ***
